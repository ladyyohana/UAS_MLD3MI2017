...
public class Bukuu implements Parcelable {
    ...
    public Bukuu(String id_buku, String judul, String ddc, String issn, String no_panggil, String penerbit, String tahun,
    ...
    public static final Creator<Bukuu> CREATOR = new Creator<Bukuu>() {
        @Override
        public Bukuu createFromParcel(Parcel source) {
            return new Bukuu(source);
        }

        @Override
        public Bukuu[] newArray(int size) {
            return new Bukuu[size];
        }
    };
}